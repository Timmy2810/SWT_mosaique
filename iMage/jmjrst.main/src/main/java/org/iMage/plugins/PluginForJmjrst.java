...
public abstract class PluginForJmjrst implements Comparable<PluginForJmjrst> {
  ...
  public int compareTo(PluginForJmjrst otherPlugin) {
    ...
    if (compared > 0 || (compared == 0 && this.getNumberOfParameters() < otherPlugin.getNumberOfParameters())) {
      return 1;
    } else if (compared < 0 || (compared == 0 && this.getNumberOfParameters() > otherPlugin.getNumberOfParameters())) {
      return -1;
    }
    return 0;
  }
